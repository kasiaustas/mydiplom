...
//        'Edit',
    ...
    margin: 30px auto 30px;">sunglasses</h2><br/><br/>
        ...
        <?php if(!empty($sale)&&empty($products_sale)):?>
            <div class="col-md-9 " id="product_panel">
                ...
                <div class="features_items"><!--features_items-->
                    ...
                    <?php $i=0; foreach ($sale as $sal):?>
                        <?php  $mainImg = $sal->getImage()?>
                        <div class="col-md-4">
                            <div id="" class="product_panel">
                                <div class="inner_product_panel" style="display:block;">

                                    <div id="img_size">
                                        <a href="<?=\yii\helpers\Url::to(['product/view', 'id'=>$sal->id_product])?>">
                                        <?= Html::img($mainImg->getUrl(), ['title'=>$sal->title, 'alt'=>$sal->title]) ?>
                                        </a>
                                    </div>
                                    ...
                                    <h4 id="title_size">
                                        ...
                                        <br>
                                        <span>РУБ<span class="category_listing_price"> <?=$sal->price?></span></span>&nbsp;
                                        <?php if(!empty($sal->sale)):?>
                                            <span class="sale_title">-&nbsp;<?=$sal->sale?>%</span>
                                        <?php endif;?>
                                    </h4>
                                    <a href="<?=\yii\helpers\Url::to(['product/view', 'id'=>$sal->id_product])?>">
