...
//        'Edit',
    ...
    margin: 30px auto 30px;">sunglasses</h2><br/><br/>
        ...
        <?php if(!empty($dior)&&empty($products_dior)):?>
            ...
            <div class="col-md-9 " id="product_panel">
                ...
                <div class="features_items"><!--features_items-->
                    ...
                    <?php $i=0; foreach ($dior as $d):?>
                        <?php  $mainImg = $d->getImage()?>
                        <div class="col-md-4">
                            <div id="" class="product_panel">
                                <div class="inner_product_panel" style="display:block;">
                                    ...
                                    <div id="img_size">
                                        ...
                                        <?= Html::img($mainImg->getUrl(), ['title'=>$d->title, 'alt'=>$d->title]) ?>
                                        </a>
                                    </div>
                                    ...
                                    <h4 id="title_size">
                                        ...
                                        <br>
                                        <span>РУБ<span class="category_listing_price"> <?=$d->price?></span></span>&nbsp;
                                        <?php if(!empty($d->sale)):?>
                                            <span class="sale_title">-&nbsp;<?=$d->sale?>%</span>
                                        <?php endif;?>
                                    </h4>
                                    <a href="<?=\yii\helpers\Url::to(['product/view', 'id'=>$d->id_product])?>">
