                            ...
                            <div id="" class="product_panel">
                                <div class="inner_product_panel" style="display:block;">
                                    ...
                                    <h4 id="title_size">
                                        ...
                                        <br>
                                        <span>РУБ<span class="category_listing_price"> <?=$product_man->price?></span></span>&nbsp;
                                        <?php if(!empty($product_man->sale)):?>
                                            <span class="sale_title">-&nbsp;<?=$product_man->sale?>%</span>
                                        <?php endif;?>
                                    </h4>
                                    <a href="<?=\yii\helpers\Url::to(['product/view', 'id'=>$product_man->id_product])?>">
