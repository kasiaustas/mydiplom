        ...
        <?php if(!empty($products_kids)):?>
            <div class="col-md-9 " id="product_panel">
                ...
                <div class="features_items"><!--features_items-->
                    ...
                    <?php $i=0; foreach ($products_kids as $product_kids):?>
                        <?php  $mainImg = $product_kids->getImage()?>
                        <div class="col-md-4">
                            <div id="" class="product_panel">
                                <div class="inner_product_panel" style="display:block;">

                                    <div id="img_size">
                                        <a href="<?=\yii\helpers\Url::to(['product/view', 'id'=>$product_kids->id_product])?>">
                                        <?= Html::img($mainImg->getUrl(), ['title'=>$product_kids->title, 'alt'=>$product_kids->title]) ?>
                                        </a>
                                    </div>
                                    ...
                                    <h4 id="title_size">
                                        ...
                                        <br>
                                        <span>РУБ<span class="category_listing_price"> <?=$product_kids->price?></span></span>&nbsp;
                                        <?php if(!empty($product_kids->sale)):?>
                                            <span class="sale_title">-&nbsp;<?=$product_kids->sale?>%</span>
                                        <?php endif;?>
                                    </h4>
                                    <a href="<?=\yii\helpers\Url::to(['product/view', 'id'=>$product_kids->id_product])?>">
